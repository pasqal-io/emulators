...
```
cd existing_repo
git remote add origin https://gitlab.pasqal.com/emulation/rydberg-atoms/emu-ct.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.pasqal.com/emulation/rydberg-atoms/emu-ct/-/settings/integrations)
