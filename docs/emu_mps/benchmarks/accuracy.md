...
Here we discuss the emulator accuracy, as compared to Pulser state vector solver [backend](https://pulser.readthedocs.io/en/v1.6.0/apidoc/_autosummary/pulser_simulation.QutipBackend.html#qutipbackend), but in the future we might directly compare with QPU results.
